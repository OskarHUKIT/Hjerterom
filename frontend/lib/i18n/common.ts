...
export const commonTranslations = {
  no: {
    ...
    heroModuleDemoDesc:
      "Be om et skreddersydd demo og opplev hvordan Hjerterum forenkler boligformidling for kommune og utleier.",
    ...
    homeFeaturesLead:
      "Hjerterum kobler sammen kommunale behov, private utleiere og gjester — med BankID-verifisering i hvert steg.",
