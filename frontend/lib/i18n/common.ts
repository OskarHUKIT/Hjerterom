...
export const commonTranslations = {
  no: {
    ...
    mobileNavHome: "Hjem",
    mobileNavProperties: "Boliger",
    mobileNavRespond: "Svar",
    mobileNavInbox: "Innboks",
    mobileNavLosHelp: "Los-hjelp",
    mobileNavSendAlert: "Send varsel",
    mobileNavBookingsShort: "Book.",
    mobileNavBoligbankShort: "Bank",
    mobileNavAlertsShort: "Varsler",
    mobileNavInquiriesShort: "Henv.",
    ...
    pwaClose: "Lukk",
    heroTitleLine1: "Hjerterom forenkler",
    heroTitleAccent: "boligformidling",
    heroEyebrow: "Kommune · utleier · gjest",
    heroEyebrowKommune: "Kommune",
    heroEyebrowLandlord: "utleier",
    heroEyebrowGuest: "gjest",
    heroEyebrowYouth: "ungdom",
    heroEyebrowSeparator: " · ",
    heroDesc:
      "Et trygt bindeledd mellom kommuner og private utleiere — for sosial boligformidling, arrangementer og turisme. Alt sikret med BankID, bygget for hverdagen i Nord-Norge.",
    heroModuleLoginEyebrow: "Kommune · utleier",
    heroModuleLoginTitle: "Logg inn og administrer",
    heroModuleLoginTitleAccent: "boliger",
    heroModuleLoginDesc:
      "For utleiere, saksbehandlere og kommuneansatte — trygg tilgang med BankID til boligbank, avtaler og formidling.",
    heroModuleKommuneEyebrow: "Kommune",
    heroModuleKommuneTitle: "Effektiv formidling for",
    heroModuleKommuneTitleAccent: "kommuner",
    heroModuleKommuneDesc:
      "Effektiv sosial boligformidling med full oversikt, rapportering og trygg saksbehandling.",
    heroModuleLandlordEyebrow: "Utleier",
    heroModuleLandlordTitle: "List ut og formidle",
    heroModuleLandlordTitleAccent: "trygt",
    heroModuleLandlordDesc:
      "List ut boliger enkelt og trygt, med verifiserte leietakere og forutsigbare avtaler.",
    heroModuleDemoEyebrow: "Demo",
    heroModuleDemoTitle: "Se plattformen",
    heroModuleDemoTitleAccent: "i praksis",
    heroModuleDemoDesc:
      "Be om et skreddersydd demo og opplev hvordan Hjerterom forenkler boligformidling for kommune og utleier.",
    heroModuleFinnEyebrow: "Gjest · turisme",
    heroModuleFinnTitle: "Finn ditt",
    heroModuleFinnTitleAccent: "opphold",
    heroModuleFinnDesc:
      "Søk korttidsleie og arrangement i Nord-Norge — raskt og sikkert med BankID.",
    heroModuleLosEyebrow: "Ungdom · chat",
    heroModuleLosTitle: "Digital Los — trygg",
    heroModuleLosTitleAccent: "inngang",
    heroModuleLosDesc:
      "Chat-første inngang for ungdom 16–25, koblet til sosial hjelp — én samtale om gangen.",
    heroLoadingAria: "Laster innhold",
    homeTrustAria: "Hvorfor du kan stole på Hjerterom",
    homeTrustSecure: "BankID-sikret",
    homeTrustA11y: "Universell utforming",
    homeTrustNordic: "Bygget for Nord-Norge",
    homeLoginCardDesc: "For utleiere, saksbehandlere og kommuneansatte.",
    homeFeaturesEyebrow: "Hvordan det fungerer",
    homeFeaturesTitle: "Tre parter, én trygg plattform",
    homeFeaturesLead:
      "Hjerterom kobler sammen kommunale behov, private utleiere og gjester — med BankID-verifisering i hvert steg.",
    homeFeatureGoTo: "Gå til",
    homeFeatureKommuneTitle: "For kommuner",
    homeFeatureKommuneDesc:
      "Effektiv sosial boligformidling med full oversikt, rapportering og trygg saksbehandling.",
    homeFeatureLandlordTitle: "For utleiere",
    homeFeatureLandlordDesc:
      "List ut boliger enkelt og trygt, med verifiserte leietakere og forutsigbare avtaler.",
    homeFeatureFinnTitle: "For gjester",
    homeFeatureFinnDesc: "Enkel søk og booking for gjester i Nord-Norge.",
    homeFeatureLosTitle: "Digital Los",
    homeFeatureLosDesc: "Chat-første inngang for ungdom — én samtale om gangen.",
    homeDemoCardDesc: "Se plattformen i bruk med et skreddersydd demo.",
    ...
    authLandlordLoginTitle: "Logg inn for å administrere boligene dine",
    authLandlordLoginDesc: "For utleiere, kommune og ansatte.",
    authSignedInTitle: "Du er allerede innlogget",
    authSignedInAs: "Innlogget som {email}",
    authContinueSignedIn: "Fortsett",
    authSwitchAccount: "Bytt konto",
    authErrorEmailRequired: "E-post er påkrevd.",
    authErrorPasswordRequired: "Passord er påkrevd.",
    authErrorNameRequired: "Fullt navn er påkrevd ved registrering.",
    authErrorInvalidCredentials: "Feil e-post eller passord. Prøv igjen.",
    authUsePasswordInstead: "Bruk passord i stedet",
    email: "E-post",
    password: "Passord",
    fullName: "Fullt navn",
    phone: "Telefon",
    ...
    losStepContact: "Kontakt",
    losStepUnderstand: "Forståelse",
    losStepHandoff: "Kobling",
    ...
    commandPaletteOpen: "Åpne kommandopalett",
    commandPaletteOpenHint: "Trykk Ctrl+K (Cmd+K på Mac)",
    commandPalettePlaceholder: "Søk ruter, boliger eller handlinger…",
    commandPaletteSectionRecent: "Nylig",
    commandPaletteSectionNavigation: "Navigasjon",
    commandPaletteSectionListings: "Boligbank",
    commandPaletteSectionActions: "Handlinger",
    commandPaletteActionNewEvent: "Nytt arrangement",
    commandPaletteActionMarkInquiryClosed: "Merk henvendelse som lukket",
    commandPaletteActionSwitchLanguage: "Bytt språk",
    commandPaletteActionSwitchLanguageHint: "NO → SE → EN",
    commandPaletteActionToggleTheme: "Bytt tema",
    commandPaletteNoResults: "Ingen treff",
    commandPaletteResultsCount: "{count} treff",
    commandPaletteNavigateHint: "Naviger",
    commandPaletteInquiryClosed: "Henvendelsen er lukket.",
    commandPaletteInquiryCloseNone: "Ingen åpen henvendelse å lukke.",
    commandPaletteLanguageSwitched: "Språk oppdatert.",
  },
  se: {
    ...
    mobileNavHome: "Ruoktu",
    mobileNavProperties: "Boligat",
    mobileNavRespond: "Vástiit",
    mobileNavInbox: "Boasttinbáhkka",
    mobileNavLosHelp: "Los-veahki",
    mobileNavSendAlert: "Sádde almmuhusa",
    mobileNavBookingsShort: "Book.",
    mobileNavBoligbankShort: "Bank",
    mobileNavAlertsShort: "Almm.",
    mobileNavInquiriesShort: "Henv.",
    ...
    pwaClose: "Gidde",
    heroTitleLine1: "Hjerterom ovdánahttá",
    heroTitleAccent: "beaivvášformiduhttima",
    heroEyebrow: "Kommune · oamasteaddji · guossálaš",
    heroEyebrowKommune: "Kommune",
    heroEyebrowLandlord: "oamasteaddji",
    heroEyebrowGuest: "guossálaš",
    heroEyebrowYouth: "nuorat",
    heroEyebrowSeparator: " · ",
    heroDesc:
      "Sihkar oktavuohta gaskkal kommuvnnaid ja priváhta beaivvášoamasteaddji — sosiala formidemiija, arrangementa ja turisma. BankID sihkkarastá, huksejuvvon Davvi-Norgga beaivvážii.",
    heroModuleLoginEyebrow: "Kommune · oamasteaddji",
    heroModuleLoginTitle: "Logge sisa ja hálddaš",
    heroModuleLoginTitleAccent: "beaivvážaid",
    heroModuleLoginDesc:
      "Oamasteaddjiide, saksbehandleriide ja kommunebargiide — sihkar sisačáliheapmi BankID:in beaivvášbánccui, soahpamušaide ja formidemiijii.",
    heroModuleKommuneEyebrow: "Kommune",
    heroModuleKommuneTitle: "Effektiiva formidling",
    heroModuleKommuneTitleAccent: "kommunnaide",
    heroModuleKommuneDesc:
      "Effektiiva sosiala beaivvášformidling olles ovddasváhusain, raporteeremiin ja sihkar saksbehandlan.",
    heroModuleLandlordEyebrow: "Oamasteaddji",
    heroModuleLandlordTitle: "Listte ja formidle",
    heroModuleLandlordTitleAccent: "sihkkarit",
    heroModuleLandlordDesc:
      "Listte beaivvážaid álkes ja sihkkarit, verificerejuvvon leatit ja prediktabeallat soahpamušat.",
    heroModuleDemoEyebrow: "Demo",
    heroModuleDemoTitle: "Oainnát platforma",
    heroModuleDemoTitleAccent: "doaimmas",
    heroModuleDemoDesc:
      "Bivdde skuvvet demo ja oainnát movt Boly ovdánahttá beaivvášformidemiija kommuvnna ja oamasteaddjiide.",
    heroModuleFinnEyebrow: "Guossálaš · turisma",
    heroModuleFinnTitle: "Finn iežat",
    heroModuleFinnTitleAccent: "orru",
    heroModuleFinnDesc:
      "Oza gaskaboddosaš orru ja arrangement Davvi-Norggas — jođánit ja sihkkarit BankID:in.",
    heroModuleLosEyebrow: "Nuorat · chat",
    heroModuleLosTitle: "Digital Los — sihkar",
    heroModuleLosTitleAccent: "beaivváš",
    heroModuleLosDesc:
      "Chat-vuosttá nuoraid 16–25, oktan sosiala veahki — okta sáhkkal atnán.",
    heroLoadingAria: "Láhten sisdoallu",
    homeTrustAria: "Manin sáhtát luohtá Boly",
    homeTrustSecure: "BankID-várrehus",
    homeTrustA11y: "Universála hábmema",
    homeTrustNordic: "Huksejuvvon Davvi-Norggaide",
    homeLoginCardDesc: "Oamasteaddjiide, saksbehandleriide ja kommunebargiide.",
    homeFeaturesEyebrow: "Movt dat doaibmá",
    homeFeaturesTitle: "Golmma oassebelašvuohta — okta sihkar platforma",
    homeFeaturesLead:
      "Boly čatná kommunal tarbbáid, priváhta oamasteaddji ja guossálaččaid — BankID-verificeren juohke stuvvus.",
    homeFeatureGoTo: "Mana",
    homeFeatureKommuneTitle: "Kommunnaide",
    homeFeatureKommuneDesc:
      "Effektiiva sosiala beaivvášformidling olles ovddasváhusain, raporteeremiin ja sihkar saksbehandlan.",
    homeFeatureLandlordTitle: "Oamasteaddjiide",
    homeFeatureLandlordDesc:
      "Listte beaivvážaid álges ja sihkkarit, verificerejuvvon leatit ja prediktabeallat soahpamušat.",
    homeFeatureFinnTitle: "Guossálaččaide",
    homeFeatureFinnDesc: "Aiddo søk ja booking gæddjái.",
    homeFeatureLosTitle: "Digital Los",
    homeFeatureLosDesc: "Chat vuosttá nuoraid — okta sáhkkal atnán.",
    homeDemoCardDesc: "Oainnát platforma geavaheamis skuvvet demo.",
    ...
    authLandlordLoginTitle: "Logge sisa hálddašit dáviraid",
    authLandlordLoginDesc: "Utleiariid, gieldda ja bargiid várás.",
    authSignedInTitle: "Leat juo logge sisa",
    authSignedInAs: "Logge sisa {email}",
    authContinueSignedIn: "Joatkit",
    authSwitchAccount: "Molsso konto",
    authErrorEmailRequired: "E-poasta gáibiduvvo.",
    authErrorPasswordRequired: "Sálti gáibiduvvo.",
    authErrorNameRequired: "Ovdanamma gáibiduvvo registrerema.",
    authErrorInvalidCredentials: "Boastt e-poasta dahje sálti.",
    authUsePasswordInstead: "Geava sálti",
    email: "E-poasta",
    password: "Sálti",
    ...
    losTitle: "Digital Los",
    losSubtitle: "Láhten ságastallat ungdomaid birra orru ja stuorra doaimmaid",
    losExit: "Heaittit",
    ...
    losConsentRequired: "Dohkke sámegiela suodjaleapmái ovdal go sáddet.",
    losHandoffCta: "Ságastallat saksbehandleriin",
    losHandoffSent: "Dieđut leat sáddejuvvon saksbehandlerii!",
    losHandoffBanner: "Diehtu lea sirdojuvvon saksbehandlerii. Son váldá oktavuođa dál.",
    losStepContact: "Oktavuohta",
    losStepUnderstand: "Ipman",
    losStepHandoff: "Sirdin",
    losReplyHello: "Bures! Mii leat dás veahkehit du.",
    losReplyHousing: "Orru lea okta ášši maid sáhttit ságastallat.",
    losReplyCrisis: "Jus leat bálvalus, ring 113.",
    losReplyDefault: "Giitu go válddit oktavuođa.",
    ...
    commandPaletteOpen: "Raba kommandopaletta",
    commandPaletteOpenHint: "Ctrl+K (Cmd+K Mac)",
    commandPalettePlaceholder: "Oza ruteaid, boligaid dahje doaimmaid…",
    commandPaletteSectionRecent: "Aitto",
    commandPaletteSectionNavigation: "Navigerejupmi",
    commandPaletteSectionListings: "Boligbank",
    commandPaletteSectionActions: "Doaimmat",
    commandPaletteActionNewEvent: "Ođđa dáhpáhus",
    commandPaletteActionMarkInquiryClosed: "Merke jearaldaga giddán",
    commandPaletteActionSwitchLanguage: "Molsso giela",
    commandPaletteActionSwitchLanguageHint: "NO → SE → EN",
    commandPaletteActionToggleTheme: "Molsso temá",
    commandPaletteNoResults: "Ii gávdnon",
    commandPaletteResultsCount: "{count} deavsttat",
    commandPaletteNavigateHint: "Navigeren",
    commandPaletteInquiryClosed: "Jearaldat giddán.",
    commandPaletteInquiryCloseNone: "Ii leat rabas jearaldat.",
    commandPaletteLanguageSwitched: "Giella ođđasit.",
  },
  en: {
    ...
    mobileNavHome: "Home",
    mobileNavProperties: "Properties",
    mobileNavRespond: "Respond",
    mobileNavInbox: "Inbox",
    mobileNavLosHelp: "Los help",
    mobileNavSendAlert: "Send alert",
    mobileNavBookingsShort: "Book.",
    mobileNavBoligbankShort: "Bank",
    mobileNavAlertsShort: "Alerts",
    mobileNavInquiriesShort: "Inq.",
    ...
    pwaClose: "Close",
    heroTitleLine1: "Hjerterom simplifies",
    heroTitleAccent: "housing mediation",
    heroEyebrow: "Municipality · landlord · guest",
    heroEyebrowKommune: "Municipality",
    heroEyebrowLandlord: "landlord",
    heroEyebrowGuest: "guest",
    heroEyebrowYouth: "youth",
    heroEyebrowSeparator: " · ",
    heroDesc:
      "A secure link between municipalities and private landlords — for social housing mediation, events and tourism. Secured with BankID, built for everyday life in Northern Norway.",
    heroModuleLoginEyebrow: "Municipality · landlord",
    heroModuleLoginTitle: "Sign in and manage",
    heroModuleLoginTitleAccent: "properties",
    heroModuleLoginDesc:
      "For landlords, caseworkers and municipality staff — secure BankID access to the housing bank, agreements and mediation.",
    heroModuleKommuneEyebrow: "Municipality",
    heroModuleKommuneTitle: "Efficient mediation for",
    heroModuleKommuneTitleAccent: "municipalities",
    heroModuleKommuneDesc:
      "Efficient social housing mediation with full overview, reporting and secure casework.",
    heroModuleLandlordEyebrow: "Landlord",
    heroModuleLandlordTitle: "List and mediate",
    heroModuleLandlordTitleAccent: "safely",
    heroModuleLandlordDesc:
      "List properties easily and securely, with verified tenants and predictable agreements.",
    heroModuleDemoEyebrow: "Demo",
    heroModuleDemoTitle: "See the platform",
    heroModuleDemoTitleAccent: "in action",
    heroModuleDemoDesc:
      "Request a tailored demo and experience how Hjerterum simplifies housing mediation for municipalities and landlords.",
    heroModuleFinnEyebrow: "Guest · tourism",
    heroModuleFinnTitle: "Find your",
    heroModuleFinnTitleAccent: "stay",
    heroModuleFinnDesc:
      "Search short-term rentals and events in Northern Norway — quickly and securely with BankID.",
    heroModuleLosEyebrow: "Youth · chat",
    heroModuleLosTitle: "Digital Los — a safe",
    heroModuleLosTitleAccent: "entry",
    heroModuleLosDesc:
      "Chat-first entry for youth aged 16–25, connected to social support — one conversation at a time.",
    heroLoadingAria: "Loading content",
    homeTrustAria: "Why you can trust Boly",
    homeTrustSecure: "BankID secured",
    homeTrustA11y: "Universal design",
    homeTrustNordic: "Built for Northern Norway",
    homeLoginCardDesc: "For landlords, caseworkers and municipality staff.",
    homeFeaturesEyebrow: "How it works",
    homeFeaturesTitle: "Three parties, one secure platform",
    homeFeaturesLead:
      "Hjerterum connects municipal needs, private landlords and guests — with BankID verification at every step.",
    homeFeatureGoTo: "Go to",
    homeFeatureKommuneTitle: "For municipalities",
    homeFeatureKommuneDesc:
      "Efficient social housing mediation with full overview, reporting and secure casework.",
    homeFeatureLandlordTitle: "For landlords",
    homeFeatureLandlordDesc:
      "List properties easily and securely, with verified tenants and predictable agreements.",
    homeFeatureFinnTitle: "For guests",
    homeFeatureFinnDesc: "Simple search and booking for guests in Northern Norway.",
    homeFeatureLosTitle: "Digital Los",
    homeFeatureLosDesc: "Chat-first entry for youth — one conversation at a time.",
    homeDemoCardDesc: "See the platform in action with a tailored demo.",
    ...
    authLandlordLoginTitle: "Log in to manage your properties",
    authLandlordLoginDesc: "For landlords, municipality staff, and operators.",
    authSignedInTitle: "You are already signed in",
    authSignedInAs: "Signed in as {email}",
    authContinueSignedIn: "Continue",
    authSwitchAccount: "Switch account",
    authErrorEmailRequired: "Email is required.",
    authErrorPasswordRequired: "Password is required.",
    authErrorNameRequired: "Full name is required when signing up.",
    authErrorInvalidCredentials: "Incorrect email or password. Try again.",
    ...
    losStepContact: "Contact",
    losStepUnderstand: "Understanding",
    losStepHandoff: "Handoff",
    ...
    commandPaletteOpenHint: "Press Ctrl+K (Cmd+K on Mac)",
    commandPalettePlaceholder: "Search routes, listings, or actions…",
    commandPaletteSectionRecent: "Recent",
    commandPaletteSectionNavigation: "Navigation",
    commandPaletteSectionListings: "Housing bank",
    commandPaletteSectionActions: "Actions",
    commandPaletteActionNewEvent: "New event",
    commandPaletteActionMarkInquiryClosed: "Mark inquiry closed",
    commandPaletteActionSwitchLanguage: "Switch language",
    commandPaletteActionSwitchLanguageHint: "NO → SE → EN",
    commandPaletteActionToggleTheme: "Toggle theme",
    commandPaletteNoResults: "No results",
    commandPaletteResultsCount: "{count} results",
    commandPaletteNavigateHint: "Navigate",
    commandPaletteInquiryClosed: "Inquiry closed.",
    commandPaletteInquiryCloseNone: "No open inquiry to close.",
    commandPaletteLanguageSwitched: "Language updated.",
  },
} as const
