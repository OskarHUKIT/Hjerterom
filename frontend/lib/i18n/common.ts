...
export const commonTranslations = {
  no: {
    ...
    homeFeaturesTitle: "Fire baner — én plattform",
    homeFeaturesLead: "Kommune, utleier, turisme og ungdom får hver sin rolige arbeidsflate uten støy.",
    homeFeatureKommuneTitle: "Kommune saksbehandler",
    homeFeatureKommuneDesc: "Boligbank, meldinger og formidling med full oversikt.",
    homeFeatureLandlordTitle: "Utleier",
    homeFeatureLandlordDesc: "Registrer, administrer tilgjengelighet og formidle trygt.",
    homeFeatureFinnTitle: "Finn opphold",
  ...
  se: {
    ...
    homeFeaturesTitle: "Njealje bálggis — okta platforma",
    homeFeaturesLead: "Kommune, goddánus, turisma ja nuorat ožžot iežaset bálggis.",
    homeFeatureKommuneTitle: "Kommune saksbehandler",
    homeFeatureKommuneDesc: "Beaivvášbánccu, sáhcastallat ja formidling.",
    homeFeatureLandlordTitle: "Goddánus",
    homeFeatureLandlordDesc: "Registrere, hálddaš gallehusa ja formidle.",
    homeFeatureFinnTitle: "Finn orru",
  ...
  en: {
    ...
    homeFeaturesTitle: "Four lanes — one platform",
    homeFeaturesLead: "Municipality, landlord, tourism and youth each get a calm workspace without noise.",
    homeFeatureKommuneTitle: "Municipality caseworker",
    homeFeatureKommuneDesc: "Housing bank, messages and mediation with full overview.",
    homeFeatureLandlordTitle: "Landlord",
    homeFeatureLandlordDesc: "Register, manage availability and mediate safely.",
    homeFeatureFinnTitle: "Find a stay",
