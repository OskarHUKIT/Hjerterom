...
export const navTranslations = {
  no: {
    ...
    messages: "Meldinger",
    messagesThreadWith: "Samtale med {name}",
    navMore: "Mer",
    navInboxTitle: "Innboks",
    navInboxLead: "Samlet triage: henvendelser, Los-saker og utløpte avtaler — nyest først.",
    navInboxPhase2Hint: "Full triage-feed bygges i neste fase. Bruk lenkene under inntil da.",
  ...
  se: {
    ...
    messagesThreadWith: "Sáhkkal {name}in",
    navMore: "Eanet",
    navInboxTitle: "Boasttinbáhkka",
    navInboxLead: "Oktii čoahkkáigeassu: jearaldagat, Los-áššit ja loahppan šiehtadusat — ođđimusat vuosttas.",
    navInboxPhase2Hint: "Olles triage-feed huksejuvvo boahtteáššis. Geavat liŋkkaid vuolábealde dássáš.",
  ...
  en: {
    ...
    messages: "Messages",
    messagesThreadWith: "Chat with {name}",
    navMore: "More",
    navInboxTitle: "Inbox",
    navInboxLead: "Unified triage: inquiries, Los cases, and expired agreements — newest first.",
    navInboxPhase2Hint: "Full triage feed arrives in the next phase. Use the links below until then.",
