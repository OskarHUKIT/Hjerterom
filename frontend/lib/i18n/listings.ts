...
export const listingsTranslations = {
  no: {
    ...
    sharedCalendarDragHint: "Klikk og dra over datoene du vil markere.",
  ...
  se: {
    ...
    sharedCalendarDragHint: "Klikk ja drag.",
  ...
  en: {
    ...
    sharedCalendarDragHint: "Click and drag across the dates you want to mark.",
