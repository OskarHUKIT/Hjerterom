...
export const listingsTranslations = {
  no: {
    ...
    manageAdministrer: "Administrer",
    manageOpenListing: "Åpne bolig",
    homeownerSidebarLabel: "Utleier-meny",
    homeownerSidebarOpen: "Åpne meny",
    homeownerSidebarClose: "Lukk meny",
    homeownerNavAgreements: "Avtaler",
    homeownerNavBookings: "Bookinger",
    registerNewProperty: "Registrer ny bolig",
    regStepBolig: "Bolig",
    regStepLanes: "Spor",
    regStepAvailability: "Tilgjengelighet",
    regStepAgreements: "Avtaler",
    regStepContact: "Kontakt",
    regStepDetails: "Bolig",
    regStepPrice: "Pris",
    regStepPhotos: "Bilder",
    registerStepProperty: "Bolig",
    registerStepLanes: "Spor",
    registerStepPhotos: "Bilder",
    registerStepAvailability: "Tilgjengelighet",
    registerStepAgreements: "Avtaler",
    registerStepNext: "Neste",
    registerStepBack: "Tilbake",
    registerStepAria: "Registreringssteg",
    regLanesEventHint: "Meld boligen på arrangement senere under «Mine boliger».",
    ...
    signTermsIdentityDialogConfirm: "Fortsett til BankID",
    signTermsIdentityDialogCancel: "Avbryt",
    ...
    manageCalendarLink: "Rediger tilgjengelighet i bolig-hub",
    hubMobileFabAria: "Hurtighandlinger for tilgjengelighet",
    hubMobileFabMarkOpen: "Marker ledig",
    hubMobileFabMarkClosed: "Marker stengt",
    hubMobileFabPresets: "Legg til periode",
    ...
    laneSocialMeta: "Kommune og avtale",
    laneSocialDescShort: "Boligen kan formidles via kommunen når avtale og tilgjengelighet er på plass.",
    laneNeedsAgreement: "Trenger avtale",
    laneTourismMeta: "Finn / direkte booking",
    laneTourismOff: "Av",
    laneTourismLive: "Live",
    laneTourismDescShort: "Gjør boligen bookbar for turister — pris og vilkår i innstillinger.",
    laneTourismConfigure: "Innstillinger",
    laneEventActiveMeta: "{n} aktive",
    laneEventDescShort: "Meld boligen på sentrale arrangement når datoene passer.",
    laneEventOptInCta: "Se arrangement",
    ...
    availabilityFormidlaConflict: "Datoene er allerede formidlet i denne perioden.",
    availabilityUnmarked: "Ikke markert",
    sharedCalendarTitle: "Når er boligen ledig?",
    sharedCalendarLead:
      "Én kalender gjelder for sosial formidling, turisme og arrangement. Merk når boligen er åpen eller stengt.",
    sharedCalendarQuestion: "Velg hva du vil markere",
    sharedCalendarOpen: "Ledig",
    sharedCalendarClosed: "Stengt",
    sharedCalendarSave: "Lagre periode",
    sharedCalendarSaved: "Perioden er lagret.",
    sharedCalendarDragHint: "Velg start- og sluttdato i kalenderen.",
    sharedCalendarPresetSummer: "Ledig hele sommeren",
    sharedCalendarPresetClosedRest: "Stengt resten av året",
    sharedCalendarLaneDotsLegend: "Spor på ledige dager (kun visning)",
    calendarLegend: "Forklaring",
    sharedPeriodListTitle: "Dine perioder",
    sharedPeriodListEmpty: "Ingen perioder ennå — boligen er ikke markert som ledig eller stengt.",
    listingHubBackManage: "Tilbake til mine boliger",
    listingHubNotFound: "Boligen ble ikke funnet.",
    listingHubDeleted: "Boligen er slettet.",
    listingHubFormidlaReadOnly: "Boligen er under formidling. Kalender og innstillinger er låst til kommunen er ferdig.",
    listingHubSettingsTitle: "Innstillinger",
    listingHubAccordionAria: "Innstillingspaneler for spor",
    accordionExpandSection: "Vis {title}",
    accordionCollapseSection: "Skjul {title}",
    registerPropertyAccordionAria: "Boligskjema — kontakt, detaljer og pris",
    listingHubBentoAria: "Spor og medlemskap",
    listingHubLaneSocialActive: "Sosial formidling via kommune",
    listingHubLaneSocialInactive: "Kommunen har ikke sosial formidling",
    listingHubLaneTourismActive: "Turisme aktiv på Finn",
    listingHubLaneTourismInactive: "Turisme ikke aktivert",
    listingHubLaneEventCount: "{count} arrangement påmeldt",
    listingHubLaneEventInactive: "Ingen arrangement påmeldt",
    listingHubLaneOn: "På",
    listingHubLaneOff: "Av",
    regLanesSection: "Velg spor",
    regLanesSocialHint: "Sosial formidling er automatisk når kommunen abonnerer og du har signert avtale.",
    regLanesTourismHint: "Aktiver turisme for å leie ut via Finn. Krever egen avtale.",
    regLanesTourismEnable: "Aktiver turisme (Finn)",
    regAvailabilitySection: "Første tilgjengelighet",
    regAvailabilityLead: "Marker når boligen er ledig. Du kan endre dette senere.",
    regAgreementsSection: "Bekreft og publiser",
    regAgreementsLead: "Bekreft forsikring og publiser boligen. Signering med BankID kan komme etterpå.",
    sharedPeriodBadge: "Felles",
    availModeTabsAria: "Velg formål",
    availModeSocial: "Sosial",
    availModeTourism: "Turisme",
    availModeEvent: "Arrangement",
    availModeSocialDesc:
      "Kommunen ser boligen i boligbanken når du har markert den som ledig. Umarkerte dager telles ikke som tilgjengelige.",
    availModeTourismDesc:
      "Samme kalender styrer synlighet på Finn. Aktiver turisme i innstillingene for pris og booking.",
    availModeEventDesc:
      "Arrangement bruker samme ledig/stengt-kalender. Meld boligen på under Arrangement-panelet.",
    availModeEventEmpty: "Ingen aktive arrangement for denne boligen.",
    availModeEventCta: "Meld på arrangement under",
    availTodayLabel: "I dag:",
    availFormidlaTitle: "Formidlet av kommune",
    ...
    landlordBookingsPageTitle: "Bookinger",
    landlordBookingsPageLead:
      "Se og behandle booking-forespørsler fra gjester. Godta eller avslå nye forespørsler, og følg med på bekreftede og avsluttede opphold.",
    landlordBookingsFilterAll: "Alle",
    landlordBookingsFilterPending: "Venter",
    landlordBookingsFilterConfirmed: "Bekreftet",
    landlordBookingsFilterHistory: "Historikk",
    landlordBookingsColGuest: "Gjest",
    landlordBookingsColProperty: "Bolig",
    landlordBookingsColDates: "Datoer",
    landlordBookingsColNights: "Netter",
    landlordBookingsColPrice: "Totalpris",
    landlordBookingsColStatus: "Status",
    landlordBookingsColCreated: "Opprettet",
    landlordBookingsEmptyTitle: "Ingen bookinger ennå",
    landlordBookingsEmptyDesc:
      "Når gjester sender forespørsler via Finn, vises de her. Del annonsen din for å få flere bookinger.",
    landlordBookingsShareCta: "Del annonsen din",
    landlordBookingsErrorTitle: "Kunne ikke laste bookinger",
    landlordBookingsErrorDesc:
      "Noe gikk galt ved henting av bookinger. Prøv igjen — dette er ikke det samme som en tom liste.",
    landlordBookingsFilterEmpty: "Ingen bookinger i dette filteret.",
    landlordBookingsNoListingsTitle: "Registrer en bolig først",
    landlordBookingsNoListingsDesc:
      "Du trenger minst én publisert bolig før du kan motta booking-forespørsler.",
    landlordBookingsUnavailable: "Booking-modulen er ikke aktivert for denne kommune.",
    landlordBookingsManageLinkDesc: "Se og behandle booking-forespørsler fra gjester.",
    landlordBookingAcceptConfirmTitle: "Godta booking?",
    landlordBookingAcceptConfirmMessage:
      "Gjesten ({guest}) kan betale etter at du godtar forespørselen.",
    landlordBookingGuestMessage: "Melding fra gjest",
    landlordBookingContact: "Kontaktinfo",
    landlordBookingTimelineTitle: "Status",
  ...
  se: {
    ...
    manageAdministrer: "Hálddaš",
    manageOpenListing: "Raba dávvira",
    homeownerSidebarLabel: "Utleier-menyu",
    homeownerSidebarOpen: "Raba menyu",
    homeownerSidebarClose: "Gidde menyu",
    homeownerNavAgreements: "Ektut",
    homeownerNavBookings: "Bookinger",
    registerNewProperty: "Registrere ođđa dávira",
    regStepBolig: "Dávira",
    regStepLanes: "Beallit",
    regStepAvailability: "Olámuttosvuohta",
    regStepAgreements: "Ektut",
    regStepContact: "Oktavuohta",
    regStepDetails: "Dávira",
    regStepPrice: "Haddi",
    regStepPhotos: "Govvat",
    registerStepProperty: "Dávira",
    registerStepLanes: "Beallit",
    registerStepPhotos: "Govvat",
    registerStepAvailability: "Olámuttosvuohta",
    registerStepAgreements: "Ektut",
    registerStepNext: "Čuovvovaš",
    registerStepBack: "Ruovttoluotta",
    registerStepAria: "Registrerenstáigut",
    regLanesEventHint: "Sáhtát mielde lasihit arrangement dan maŋŋel go dávira lea registrerejuvvon.",
    ...
    signTermsIdentityDialogConfirm: "Joatkit BankID:i",
    signTermsIdentityDialogCancel: "Gaskkalduhte",
    ...
    manageCalendarLink: "Rievdat olámuttosvuođa dávira-hubas",
    hubMobileFabAria: "Áiggiiválddehus olámuttosvuođa",
    hubMobileFabMarkOpen: "Merke olámuttos",
    hubMobileFabMarkClosed: "Merke giddejuvvon",
    hubMobileFabPresets: "Lasit áigodaga",
    managePanelEvents: "Arrangement",
    ...
    laneSocialMeta: "Kommune ja oaivámuš",
    laneSocialDescShort: "Dávira sáhttá formidla kommune bokte go oaivámuš ja olámuttuvuohta leat ordnet.",
    laneNeedsAgreement: "Fertet oaivámuša",
    laneTourismMeta: "Finn / njuolga booking",
    laneTourismOff: "Gidde",
    laneTourismLive: "Live",
    laneTourismDescShort: "Raba dávvira turisttaide — háhkaid ja eavttuid heivehusat.",
    laneTourismConfigure: "Heivehusat",
    laneEventActiveMeta: "{n} aktiiva",
    laneEventDescShort: "Meld dávvira guovddálaš arrangementide go dát fitná.",
    laneEventOptInCta: "Čájet arrangement",
    ...
    availabilityFormidlaConflict: "Dáidot leat juo formidla.",
    availabilityUnmarked: "Ii merkejuvvon",
    sharedCalendarTitle: "Go lea várri olámuttos?",
    sharedCalendarLead: "Okta kalendar gusto sosiála, turisma ja arrangement.",
    sharedCalendarQuestion: "Vállje",
    sharedCalendarOpen: "Olámuttos",
    sharedCalendarClosed: "Giddejuvvon",
    sharedCalendarSave: "Vurke",
    sharedCalendarSaved: "Vurkejuvvon.",
    sharedCalendarDragHint: "Vállje álgge- ja loahppabeivvi kalendaras.",
    sharedCalendarPresetSummer: "Olámuttos geassi",
    sharedCalendarPresetClosedRest: "Giddejuvvon maŋos",
    sharedCalendarLaneDotsLegend: "Beallit olámuttos beaivviin (dušše čájet)",
    calendarLegend: "Čilgehus",
    sharedPeriodListTitle: "Du periodat",
    sharedPeriodListEmpty: "Ii perioda — ii merkejuvvon.",
    listingHubBackManage: "Ruovttoluotta mu dáviraide",
    listingHubNotFound: "Dávira ii gávdnon.",
    listingHubDeleted: "Dávira sihkkon.",
    listingHubFormidlaReadOnly: "Dávira lea formidla vuolde. Kalendar ja heivehusat leat lohkkaduvvon.",
    listingHubSettingsTitle: "Heivehusat",
    listingHubAccordionAria: "Heivehuspanelat spáidduide",
    accordionExpandSection: "Čájet {title}",
    accordionCollapseSection: "Čiega {title}",
    registerPropertyAccordionAria: "Dávvirskema — oktavuoddu, dieđut ja pris",
    listingHubBentoAria: "Beallit ja lahtut",
    listingHubLaneSocialActive: "Sosiála formidla kommune bokte",
    listingHubLaneSocialInactive: "Kommune ii leat sosiála formidla",
    listingHubLaneTourismActive: "Turisma aktiiva Finnis",
    listingHubLaneTourismInactive: "Turisma ii aktiverejuvvon",
    listingHubLaneEventCount: "{count} arrangement mielde",
    listingHubLaneEventInactive: "Ii arrangement mielde",
    listingHubLaneOn: "Bija",
    listingHubLaneOff: "Gidde",
    regLanesSection: "Vállje bealli",
    regLanesSocialHint: "Sosiála formidla lea automáhtalaš go kommune lea mielde ja don leat signeren.",
    regLanesTourismHint: "Aktivere turisma Finnis. Gáibida iežas ektu.",
    regLanesTourismEnable: "Aktivere turisma (Finn)",
    regAvailabilitySection: "Vuosttaš olámuttosvuohta",
    regAvailabilityLead: "Merke go dávira lea olámuttos. Sáhtát rievdadit maŋos.",
    regAgreementsSection: "Nanne ja almmut",
    regAgreementsLead: "Nanne sirdovuođa ja almmut dávvira. BankID-signeren boahtá maŋos.",
    sharedPeriodBadge: "Oktasaš",
    availModeTabsAria: "Vállje",
    availModeSocial: "Sosiála",
    availModeTourism: "Turisma",
    availModeEvent: "Arrangement",
    availModeSocialDesc: "Gielda oaidná du várri go lea merkejuvvon olámuttos.",
    availModeTourismDesc: "Seamma kalendar stivre Finn.",
    availModeEventDesc: "Arrangement geavaha seamma kalendara.",
    availModeEventEmpty: "Ii aktiiva arrangement.",
    availModeEventCta: "Meld på",
    availTodayLabel: "Odne:",
    availFormidlaTitle: "Formidla gielddas",
    ...
    landlordBookingsPageTitle: "Bookinger",
    landlordBookingsPageLead:
      "Geahča ja doaimmet booking-jearaldagaid leietakerin. Dohkke dahje hilggon ođđa jearaldagaid, ja čuovvo dohkkehuvvon ja loahpahuvvon boahtima.",
    landlordBookingsFilterAll: "Buot",
    landlordBookingsFilterPending: "Vuordá",
    landlordBookingsFilterConfirmed: "Dohkkehuvvon",
    landlordBookingsFilterHistory: "Historihkka",
    landlordBookingsColGuest: "Leietaker",
    landlordBookingsColProperty: "Dávvir",
    landlordBookingsColDates: "Beaivvit",
    landlordBookingsColNights: "Idjideattit",
    landlordBookingsColPrice: "Oppalaš ávki",
    landlordBookingsColStatus: "Stáhtus",
    landlordBookingsColCreated: "Ráhkaduvvon",
    landlordBookingsEmptyTitle: "Ii leat bookinger dál",
    landlordBookingsEmptyDesc:
      "Go leietaker sáddet jearaldagaid Finna bokte, oidnojit dás. Juoge dieđuid dávviris ođđa bookingaid várás.",
    landlordBookingsShareCta: "Juoge dávvira",
    landlordBookingsErrorTitle: "Ii sáhttán viežžat bookinger",
    landlordBookingsErrorDesc:
      "Juoga manai boasttut viežžamis. Geahččal fas — dát ii leat seamma go guoros listu.",
    landlordBookingsFilterEmpty: "Ii leat bookinger dán filteris.",
    landlordBookingsNoListingsTitle: "Registrere dávvira vuosttaš",
    landlordBookingsNoListingsDesc:
      "Don dárbbašat unnimustá ovtta almmuhuvvon dávvira ovdal go sáhtát oažžut booking-jearaldagaid.",
    landlordBookingsUnavailable: "Booking-modul ii leat aktiviserejuvvon dán gildii.",
    landlordBookingsManageLinkDesc: "Geahča ja doaimmet booking-jearaldagaid leietakerin.",
    landlordBookingAcceptConfirmTitle: "Dohkket booking?",
    landlordBookingAcceptConfirmMessage:
      "Leietaker ({guest}) sáhttá máksit maŋŋel go don dohkket jearaldaga.",
    landlordBookingGuestMessage: "Sáhkká leietakeris",
    landlordBookingContact: "Oktačuohkan",
    landlordBookingTimelineTitle: "Stáhtus",
  ...
  en: {
    ...
    manageAdministrer: "Manage",
    manageOpenListing: "Open listing",
    homeownerSidebarLabel: "Landlord menu",
    homeownerSidebarOpen: "Open menu",
    homeownerSidebarClose: "Close menu",
    homeownerNavAgreements: "Agreements",
    homeownerNavBookings: "Bookings",
    registerNewProperty: "Register new property",
    regStepBolig: "Property",
    regStepLanes: "Lanes",
    regStepAvailability: "Availability",
    regStepAgreements: "Agreements",
    regStepContact: "Contact",
    regStepDetails: "Property",
    regStepPrice: "Pricing",
    regStepPhotos: "Photos",
    registerStepProperty: "Property",
    registerStepLanes: "Lanes",
    registerStepPhotos: "Photos",
    registerStepAvailability: "Availability",
    registerStepAgreements: "Agreements",
    registerStepNext: "Next",
    registerStepBack: "Back",
    registerStepAria: "Registration steps",
    regLanesEventHint: "Opt in to events later under My properties.",
    ...
    signTermsIdentityDialogConfirm: "Continue to BankID",
    signTermsIdentityDialogCancel: "Cancel",
    ...
    manageCalendarLink: "Edit availability in listing hub",
    hubMobileFabAria: "Quick availability actions",
    hubMobileFabMarkOpen: "Mark open",
    hubMobileFabMarkClosed: "Mark closed",
    hubMobileFabPresets: "Add period",
    ...
    laneSocialMeta: "Municipality and agreement",
    laneSocialDescShort: "The property can be mediated via the municipality once agreement and availability are in place.",
    laneNeedsAgreement: "Agreement required",
    laneTourismMeta: "Finn / direct booking",
    laneTourismOff: "Off",
    laneTourismLive: "Live",
    laneTourismDescShort: "Make the property bookable for tourists — set price and terms in settings.",
    laneTourismConfigure: "Settings",
    laneEventActiveMeta: "{n} active",
    laneEventDescShort: "Opt in to central events when the dates fit your property.",
    laneEventOptInCta: "View events",
    ...
    availabilityFormidlaConflict: "These dates are already mediated in this period.",
    availabilityUnmarked: "Unmarked",
    sharedCalendarTitle: "When is the property available?",
    sharedCalendarLead:
      "One calendar applies to social mediation, tourism, and events. Mark when the property is open or closed.",
    sharedCalendarQuestion: "Choose what to mark",
    sharedCalendarOpen: "Open",
    sharedCalendarClosed: "Closed",
    sharedCalendarSave: "Save period",
    sharedCalendarSaved: "Period saved.",
    sharedCalendarDragHint: "Select start and end dates in the calendar.",
    sharedCalendarPresetSummer: "Open all summer",
    sharedCalendarPresetClosedRest: "Closed for the rest of the year",
    sharedCalendarLaneDotsLegend: "Lanes on open days (display only)",
    calendarLegend: "Legend",
    sharedPeriodListTitle: "Your periods",
    sharedPeriodListEmpty: "No periods yet — the property is not marked open or closed.",
    listingHubBackManage: "Back to my properties",
    listingHubNotFound: "Property not found.",
    listingHubDeleted: "Property deleted.",
    listingHubFormidlaReadOnly: "The property is being mediated. Calendar and settings are locked until the municipality is done.",
    listingHubSettingsTitle: "Settings",
    listingHubAccordionAria: "Lane settings panels",
    accordionExpandSection: "Show {title}",
    accordionCollapseSection: "Hide {title}",
    registerPropertyAccordionAria: "Property form — contact, details and price",
    listingHubBentoAria: "Lanes and membership",
    listingHubLaneSocialActive: "Social mediation via municipality",
    listingHubLaneSocialInactive: "Municipality has no social mediation",
    listingHubLaneTourismActive: "Tourism active on Finn",
    listingHubLaneTourismInactive: "Tourism not enabled",
    listingHubLaneEventCount: "{count} events opted in",
    listingHubLaneEventInactive: "No events opted in",
    listingHubLaneOn: "On",
    listingHubLaneOff: "Off",
    regLanesSection: "Choose lanes",
    regLanesSocialHint: "Social mediation is automatic when the municipality subscribes and you have signed the agreement.",
    regLanesTourismHint: "Enable tourism to rent via Finn. Requires a separate agreement.",
    regLanesTourismEnable: "Enable tourism (Finn)",
    regAvailabilitySection: "First availability",
    regAvailabilityLead: "Mark when the property is available. You can change this later.",
    regAgreementsSection: "Confirm and publish",
    regAgreementsLead: "Confirm insurance and publish the property. BankID signing may follow.",
    sharedPeriodBadge: "Shared",
    availModeTabsAria: "Choose purpose",
    availModeSocial: "Social",
    availModeTourism: "Tourism",
    availModeEvent: "Event",
    availModeSocialDesc:
      "The municipality sees the property in the housing bank when you mark it open. Unmarked days are not treated as available.",
    availModeTourismDesc:
      "The same calendar controls visibility on Finn. Enable tourism in settings for price and bookings.",
    availModeEventDesc:
      "Events use the same open/closed calendar. Opt in under the Events panel.",
    availModeEventEmpty: "No active events for this property.",
    availModeEventCta: "Opt in to events under",
    availTodayLabel: "Today:",
    availFormidlaTitle: "Mediated by municipality",
    ...
    landlordBookingsPageTitle: "Bookings",
    landlordBookingsPageLead:
      "Review and act on guest booking requests. Accept or decline new requests, and track confirmed and completed stays.",
    landlordBookingsFilterAll: "All",
    landlordBookingsFilterPending: "Pending",
    landlordBookingsFilterConfirmed: "Confirmed",
    landlordBookingsFilterHistory: "History",
    landlordBookingsColGuest: "Guest",
    landlordBookingsColProperty: "Property",
    landlordBookingsColDates: "Dates",
    landlordBookingsColNights: "Nights",
    landlordBookingsColPrice: "Total price",
    landlordBookingsColStatus: "Status",
    landlordBookingsColCreated: "Created",
    landlordBookingsEmptyTitle: "No bookings yet",
    landlordBookingsEmptyDesc:
      "When guests send requests through Finn, they appear here. Share your listing to get more bookings.",
    landlordBookingsShareCta: "Share your listing",
    landlordBookingsErrorTitle: "Could not load bookings",
    landlordBookingsErrorDesc:
      "Something went wrong while fetching bookings. Try again — this is not the same as an empty list.",
    landlordBookingsFilterEmpty: "No bookings in this filter.",
    landlordBookingsNoListingsTitle: "Register a property first",
    landlordBookingsNoListingsDesc:
      "You need at least one published property before you can receive booking requests.",
    landlordBookingsUnavailable: "The booking module is not enabled for this municipality.",
    landlordBookingsManageLinkDesc: "Review and act on guest booking requests.",
    landlordBookingAcceptConfirmTitle: "Accept booking?",
    landlordBookingAcceptConfirmMessage:
      "The guest ({guest}) can pay after you accept the request.",
    landlordBookingGuestMessage: "Message from guest",
    landlordBookingContact: "Contact info",
    landlordBookingTimelineTitle: "Status",
