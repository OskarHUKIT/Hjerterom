...
export const listingsTranslations = {
  no: {
    ...
    uploadBrowseFile: "Velg fil",
    uploadChooseOrDrop: "Velg fil eller dra den hit.",
    uploadStatusUploading: "Laster opp …",
    uploadStatusCompleted: "Fullført",
    uploadStatusError: "Opplasting feilet",
  ...
  se: {
    ...
    uploadBrowseFile: "Vállje fiilla",
    uploadChooseOrDrop: "Vállje fiilla dahje sirdde dan dán.",
    uploadStatusUploading: "Viežžá …",
    uploadStatusCompleted: "Loahppan",
    uploadStatusError: "Nammamii ii lihkostuvvan",
  ...
  en: {
    ...
    uploadBrowseFile: "Browse file",
    uploadChooseOrDrop: "Choose a file or drag & drop it here.",
