...
export const translations = {
  no: {
    ...
    lanePaintDisabledHint: 'Aktiver turisme eller arrangement først',
    ...
    laneCalendarMultipleEvents: 'Flere arrangement overlapper — bruk listen under for å velge riktig.',
  ...
  se: {
    ...
    lanePaintDisabledHint: 'Aktiver turisme dahje arrangement',
    ...
    laneCalendarApplyEvent: 'Opt-in arrangement',
    ...
    calendarPrevMonth: 'Ovddemus',
    calendarNextMonth: 'Boahtte',
  ...
  en: {
    ...
    lanePaintDisabledHint: 'Enable tourism or events first',
    laneCalendarTitle: 'Paint your calendar',
    laneCalendarLead:
      'Pick social, tourism, or event, drag across dates, and save. Each color shows what the property is open for.',
    laneCalendarEventHint:
      'Events use opt-in. Select dates that overlap an event and confirm to register the property.',
    ...
    laneCalendarMultipleEvents: 'Multiple events overlap — use the list below to pick the right one.',
