...
export const translations = {
  no: {
    ...
    eventDashboardLead: 'Du ser kun arrangement du er tildelt. Sosial boligbank og meldinger er ikke tilgjengelig her.',
  ...
  en: {
    ...
    eventDashboardLead: 'You only see events you are assigned to. Social housing bank is not available here.',
