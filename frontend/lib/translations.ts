...
export const translations = {
  no: {
    ...
    opsNavHealth: 'Helse',
    opsServiceAreasLead: 'Grupper kommuner for delt chat og administrasjon (f.eks. Narvik + Gratangen + Evenes).',
    ...
    opsServiceAreasMembersHint: 'Velg hvilke kommuner som hører til området. Primærkommune markeres med radioknapp.',
    ...
    opsViewOnlyAccessHint: 'Kan se boliger og brukere, men ikke redigere, formidle eller sende meldinger.',
    ...
    opsTermsLead: 'Godkjenn vilkårsdokumenter fra kommuner før utleiere kan signere med BankID.',
    ...
    finnBookingLead: 'Utleier godkjenner forespørselen. Betaling aktiveres når Stripe er koblet til.',
    ...
    finnEventBookingNotAllowed: 'Denne boligen kan ikke bookes direkte via dette arrangementet. Bruk henvendelsesskjemaet på arrangementssiden.',
    ...
    opsEventGeographyLead: 'Begrens hvilke kommuner og regioner arrangementet gjelder for (valgfritt).',
    ...
    losWelcome: 'Hei! Jeg er Los. Fortell kort hva du trenger hjelp med — bolig, økonomi eller noe annet?',
    losInputPlaceholder: 'Skriv melding…',
    losSend: 'Send',
    losConsentLabel: 'Jeg samtykker til at samtalen kan overleveres til saksbehandler i min kommune.',
    ...
    losReplyHousing: 'Det høres ut som du trenger hjelp med bolig. Vil du snakke med en saksbehandler?',
    losReplyCrisis: 'Hvis du er i akutt fare, ring 113. Jeg kan koble deg til saksbehandler.',
    ...
    eventDashboardLead: 'Du ser kun arrangement du er tildelt. Boligbanken viser boliger med aktiv event-opt-in.',
    bookingChatNoReceiver: 'Gjesten har ikke konto ennå — meldingen lagres, men de får ikke varsel i appen.',
    ...
    landlordAgreementsLead: 'Én signering per område (kommune, turisme, event) dekker alle matchende boliger. Ny signering kreves ved nytt valg.',
    ...
    stripeConnectLead: 'Gjesten betaler via finn.hjerterum.no. Utbetaling går til din Stripe-konto.',
  ...
  en: {
    ...
    opsNavHealth: 'Health',
    opsServiceAreasLead: 'Group municipalities for shared chat and administration (e.g. Narvik + Gratangen + Evenes).',
    ...
    opsServiceAreasMembersHint: 'Select member municipalities. Mark the primary host with the radio button.',
    ...
    opsViewOnlyAccessHint: 'Can browse listings and users, but not edit, mediate, or send messages.',
    ...
    opsInvitePreSignupHint: 'Adds one invitation row per municipality (multiple rows per email allowed).',
    ...
    opsTermsLead: 'Approve municipality terms documents before landlords can sign with BankID.',
    ...
    opsDpoLead: 'Register the municipality data protection officer (DPO) for GDPR compliance.',
    ...
    tourismEnableBannerBody: 'Turn on tourism to paint green periods on the calendar and appear on Finn.',
    ...
    finnBookingLead: 'The landlord approves the request. Payment activates when Stripe is connected.',
    ...
    finnEventBookingNotAllowed: 'This listing cannot be booked directly for this event. Use the inquiry form on the event page.',
    ...
    finnInquiryLeadStored: 'Your inquiry is sent to staff or landlord. You will be contacted by email.',
    ...
    opsEventGeographyLead: 'Limit which municipalities and regions this event applies to (optional).',
    ...
    losWelcome: 'Hi! I am Los. Briefly tell me what you need help with — housing, finances, or something else?',
    losInputPlaceholder: 'Type a message…',
    losSend: 'Send',
    losConsentLabel: 'I consent to this conversation being handed off to a caseworker in my municipality.',
    ...
    losReplyHousing: 'It sounds like you need housing help. Would you like to speak with a caseworker?',
    losReplyCrisis: 'If you are in immediate danger, call emergency services. I can connect you to a caseworker.',
    losReplyDefault: 'Thank you for sharing. Would you like me to connect you with a caseworker?',
    ...
    eventDashboardLead: 'You only see events you are assigned to. The housing bank shows listings with active event opt-in.',
    bookingChatNoReceiver: 'The guest has no account yet — the message is saved but they will not get an in-app notification.',
    ...
    landlordAgreementsLead: 'One signature per scope covers all matching properties. Re-sign when you opt into something new.',
