...
export const translations = {
  no: {
    ...
    homeTrustAria: 'Kvalitetsmerker for plattformen',
    homeTrustSecure: 'Trygg formidling',
    homeTrustA11y: 'Tilgjengelig design',
    homeTrustNordic: 'Bygget for Nord-Norge',
  ...
  se: {
    ...
    skipToMain: 'Njuoskat váldosisdoallui',
    homeTrustAria: 'Kvalitehtamerkkat',
    homeTrustSecure: 'Sihkar formiddeapmi',
    homeTrustA11y: 'Oažžu doaibmat',
    homeTrustNordic: 'Huksejuvvon Davvi-Norgii',
  ...
  en: {
    ...
    homeTrustAria: 'Platform quality indicators',
    homeTrustSecure: 'Secure mediation',
    homeTrustA11y: 'Accessible design',
    homeTrustNordic: 'Built for Northern Norway',
