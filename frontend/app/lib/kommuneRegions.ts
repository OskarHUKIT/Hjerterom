...
/**
 * Normaliser sted/kommune fra listing.city for sammenligning med kommune_region (små bokstaver, uten diakritikk, uten «kommune»-suffiks).
 */
