...
const calendarNavButtonClass =
  'inline-flex size-9 items-center justify-center rounded-lg p-0 text-muted-foreground/80 transition-colors hover:bg-accent hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 disabled:pointer-events-none disabled:opacity-50'
...
function Calendar({
  ...
  const defaultClassNames = {
    ...
    button_previous: cn(calendarNavButtonClass),
    button_next: cn(calendarNavButtonClass),
