      ...
      <div style={{ display: 'grid', gridTemplateColumns: isNavView ? '1.5fr 1fr' : '1fr', gap: 'var(--space-8)', alignItems: 'start' }}>
        ...
        <div style={{ display: 'grid', gap: 'var(--space-6)' }}>
          <div style={{ 
            ...
            <div style={{ position: 'absolute', top: 20, left: 20, padding: '6px 16px', borderRadius: '20px', background: listing.status === 'Ledig' ? 'var(--color-teal)' : '#ef4444', color: 'white', fontWeight: 800, fontSize: '0.8rem', textTransform: 'uppercase', zIndex: 5 }}>
              {listing.status}
            </div>
          </div>
