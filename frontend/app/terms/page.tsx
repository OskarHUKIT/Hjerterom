    ...
    <main className="container">
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ fontSize: '1.1rem', color: 'var(--color-dark-navy)', opacity: 0.8 }}>
          Se og administrer vilkårsavtaler for Boly
        </p>
      </div>
      ...
      <div className="card">
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
            ...
            <div>
              <h3 style={{ margin: 0, color: 'var(--color-dark-navy)' }}>Vilkårsavtale Boly</h3>
              <p
                style={{
                  margin: 0,
                  fontSize: '0.9rem',
              ...
              >
                Dokument: Vilkårsavtale Boly.docx
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <strong style={{ color: 'var(--color-dark-navy)' }}> Vilkårsavtale Boly.docx</strong>
          </p>
          <div
            style={{
              marginTop: '2rem',
              padding: '1.5rem',
              background:
                'linear-gradient(135deg, var(--color-sky-blue) 0%, rgba(170, 223, 240, 0.3) 100%)',
              borderRadius: '10px',
