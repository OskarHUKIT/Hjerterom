...
serve(async (req) => {
  ...
  try {
    ...
    const approveHint =
      "Godkjennelse: I Supabase Dashboard → Table Editor → tabellen public.terms_documents, finn raden med denne ID-en og sett kolonnen approved_for_utleier_signing til true (eller kjør tilsvarende UPDATE i SQL Editor)."
    const textBody = [
      "Hei,",
      "",
