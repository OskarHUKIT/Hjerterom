...
-- GDPR dataeksport (Privacy Center): kjør hele filen
-- supabase/migrations/20260607130000_fix_rpc_user_data_export.sql
-- i SQL Editor hvis db push ikke er kjørt, og sett SUPABASE_SERVICE_ROLE_KEY på Vercel.

-- Push-trigger (notifications → send-push): kjør hele filen
-- supabase/migrations/20260607140000_notification_push_trigger.sql
-- + vault.create_secret for project_url og anon_key (se docs/PWA_PUSH_SETUP.md).
