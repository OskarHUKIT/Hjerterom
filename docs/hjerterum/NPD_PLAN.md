...
|-------|--------|---------------|----------------------|
| NPD-0A | **Ferdig** | `npd-0a-skip-i18n` | Liten (1 fil + smoke) |
| NPD-0B | **Ferdig** (SQL + fix script) | `npd-0b-event-seed` | Liten (SQL + verifikasjon) |
| NPD-1A | **Ferdig** | `npd-1a-marketing` | Medium |
| NPD-1B | **Ferdig** | `npd-1b-nav-chrome` | Medium |
| NPD-2 | **Ferdig** | `npd-2-event-sb` | Liten |
| NPD-3A | **Ferdig** (P1 migrasjon + UI) | `npd-3a-guest-thread` | Stor |
| NPD-3B | **Manuell smoke** | `npd-3b-instant-book` | Medium |
| NPD-3C | **Ferdig** (Stripe + Vipps UI) | `npd-3c-vipps` | Stor |
| NPD-3D | **Ferdig** (first-book-wins migrasjon) | `npd-3d-concurrency` | Medium |
| NPD-4A | **Ferdig** | `npd-4a-finn-i18n` | Medium |
| NPD-4B | **Ferdig** (`npm run i18n-audit`) | `npd-4b-sami` | Medium (grep + oversettelser) |
